...
${OBJECTDIR}/AIPlayer.o: AIPlayer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AIPlayer.o AIPlayer.cpp
...
${OBJECTDIR}/CardLogic.o: CardLogic.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${OBJECTDIR}/TurnManager.o: TurnManager.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TurnManager.o TurnManager.cpp
